            ...
            <form action="../validadores/guardarDatosPerfil.php" method="post" enctype="multipart/form-data">
               ...
               header("Location: ../plantilla/login.php");
                ...
                if (isset($_SESSION["nombreCompleto"])) {
                    ...
                    echo '<p style="color: white;">Nombre completo: <input type="text" id="nombreCompleto" name="nombreCompleto" style="color: white;"  placeholder="nombreCompleto" required class="password" value="' . $nombreCompleto . '" readonly></p>';
                } else {
                ...
                if (isset($_SESSION["correoElectronico"])) {
                    ...
                    echo '<p style="color: white;">Correo Electronico: <input type="text" id="correoElectronico" name="correoElectronico"style="white: black;" placeholder="correoElectronico" required class="password" value="' . $correoElectronico . '" readonly></p>';
                } else {
                    echo 'No se ha iniciado sesión.';
                }
                echo '<br>';
                if (isset($_SESSION["password"])) {
                    ...
                    echo '<p style="color: white;">Contraseña: <input type="text" id="password" name="password" placeholder="password" style="color: white;" required class="password" value="' . $password . '" ></p>';
                } else {
                    echo 'No se ha iniciado sesión.';
                }
                echo '<br>';
                if (isset($_SESSION["descripcion"])) {
                    ...
                    echo '<p style="color: white;">Descripcion: <input type="text" id="descripcion" name="descripcion" placeholder="descripcion" style="white: black;" required class="password" value="' . $descripcion . '" ></p>';
                ...
                <label for="foto" style="color: white;">Cambair la foto de perfil:</label>';
                 <br>;
                <input type="file" name="imagen" id="imagen" style="white: black;">';
                ...
                if (isset($_SESSION["idioma"])) {
                    ...
                    echo '<p style="white: black;">Idiomas seleccionados: <input type="text" id="idioma" name="idioma"  required class="password" value="' . $idioma . '" readonly></p>';
                } else {
