...
<body class="logged-out env-production page-responsive height-full d-flex flex-column header-overlay intent-mouse"
    ...
    <div class="container">
        <div class="signup-space">
            ...
            <h2>PERFIL</h2>
            <br>
            <form action="recogeryValidar.php" method="post"  enctype="multipart/form-data">
                <?php
                session_start();
                ...
                if (isset($_SESSION["password"])) {
                    ...
                    echo '<p style="color: white;">Contraseña: <input type="text" id="password" name="password" placeholder="password" required class="password" value="' . $password . '" ></p>';
                } else {
                    echo 'No se ha iniciado sesión.';
                }
                echo '<br>';
