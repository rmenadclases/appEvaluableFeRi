            ...
            <form action="profile1.php" method="get">
                ...
                <div class="select-options">
                    ...
                    <select id="categoria" name="categoria" required >
                        <option value="categoria1"class="prueba">Categoría 1</option>
                        <option value="categoria2"class="prueba">Categoría 2</option>
                        <option value="categoria3"class="prueba">Categoría 3</option>
                    </select>
                </div>
